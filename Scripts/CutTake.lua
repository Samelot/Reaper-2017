reaper.Undo_BeginBlock();
  ...
  guids_t = {}
  retval, user_take_num_s = reaper.GetUserInputs("Delete take x of selected items", 1, "take number", "")
...
reaper.Undo_EndBlock("remove take x from selected items",0)  
