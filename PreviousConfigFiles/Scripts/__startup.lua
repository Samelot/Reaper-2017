...
splash = (script_path .. "Mydaw\\ReaperResources\\MyDawSplash.png")
metr_up = (script_path .. "Mydaw\\ReaperResources\\Metronome\\MetronomeUp.wav")
metr = (script_path .. "Mydaw\\ReaperResources\\Metronome\\Metronome.wav")
...
dofile(script_path .. "MyDaw/NextScreenset.lua") 

reaper.Main_OnCommand(40444, 0) -----Load Screenseet 1

reaper.Main_OnCommand(41105, 0) -------Switch to Toolbar 1

dofile(script_path .. "MyDaw/Interface Override.lua") 

dofile(script_path .. "MyDaw/VKB_Start.lua") 

dofile(script_path .. "MyDaw/Mouse_Start.lua") 
