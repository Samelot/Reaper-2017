...
jsUnselectNotInTime()
reaper.MIDIEditor_OnCommand(midieditor, 40883) --Dup
...
reaper.Undo_BeginBlock(); reaper.PreventUIRefresh(1)
midieditor = reaper.MIDIEditor_GetActive()
reaper.MIDIEditor_OnCommand(midieditor, 40752) -- set time selection to selected notes
...
if endOut == 0 then DupNoTimeSel()
elseif endOut > 0 then DupTimeSel()
end 
