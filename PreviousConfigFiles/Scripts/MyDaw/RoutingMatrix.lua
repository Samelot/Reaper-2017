...
all_items = reaper.CountSelectedMediaItems(0)
  ...
  for i = 0, all_items-1 do
    ...
    reaper.TakeFX_AddByName(MediaItem_Take, "(Split)RackSplitter", 1)
...
all_items = reaper.CountSelectedMediaItems(0)
  ...
  for i = 0, all_items-1 do
    ...
    reaper.TakeFX_AddByName(MediaItem_Take, "(Mix)RackMixer", 1)
...
function draw_close(target, x,y, w, h,modeName)
    --================================================================
    local text = " X "
    --================================================================
    if (modeName == "take" )
...
function DRAW()
    ...
    then
        ...
        --============================================================
        draw_close(target,   w+offset_X, h/2.5+offset_Y, w, h-2,modeName);
...
char = gfx.getchar()
if char == 32 then -- spacebar pressed
