-- Based amagalma_Smart contextual zoom
-- @author amagalma
...
if (savedTCPView==nil) or (savedTCPView == "") then





if mouseTrack ==nil then FitAllTracksIntoView() end
...
-- TCP track
if cursor_context == 0 and mouseTrack  then
