...
----------------
if maxvol()+1 > vlimit then nudge=(vlimit-maxvol())  end 
if maxvol() >= vlimit then return end 
...
reaper.PreventUIRefresh(-1); reaper.Undo_EndBlock('Nudge volume up 1 db', -1)
end
...
reaper.Main_OnCommand(41925,0) -----Item: Nudge items volume +1dB
